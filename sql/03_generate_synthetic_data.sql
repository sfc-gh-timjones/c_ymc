...
-- NOTE: EMPLOYEES is populated by 04_generate_employees_faker.sql (runs AFTER this script).
-- IT_TICKETS and ONBOARDING_TASKS reference EMPLOYEE_ID via UNIFORM(1, 6000, RANDOM()) —
-- Snowflake does not enforce FK constraints, so they run cleanly before EMPLOYEES is populated.
-- =============================================================================
